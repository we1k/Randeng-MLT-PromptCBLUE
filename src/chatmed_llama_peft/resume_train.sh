...
lora_trainable=".*(1[6_9]|2[0-9]|3[0-1]).*(q_proj|k_proj|down_proj|up_proj|gate_proj)"
...
torchrun \
    ...
    --resume_from_checkpoint checkpoint/PromptCBLUE-alpaca-llama-7b-lora-2e-4/checkpoint-5000 \
